            ...
            try:
                ...
                if stats_data:
                    ...
                    if 'Total' in stats_data:
                        ...
                        performance_metrics += f"- 90%响应时间: {total_stats['pct1ResTime']}ms\n"
                        performance_metrics += f"- 95%响应时间: {total_stats['pct2ResTime']}ms\n"
                        performance_metrics += f"- 99%响应时间: {total_stats['pct3ResTime']}ms\n"
